...
export default function EmergencyBar() {
  const items = [
    ...
    'Veteran owned and family owned',
    `Serving ${site.serviceArea}`,
    'Same-day appointments available',
  ];

  return (
    <div className="bg-brand-navy text-white text-xs overflow-hidden">
      <div className="container py-2 flex items-center gap-4">
        <div className="inline-flex items-center gap-2 whitespace-nowrap">
          ...
          <span className="uppercase tracking-[0.18em] text-[10px] text-white/80">Emergency dispatch</span>
        </div>
